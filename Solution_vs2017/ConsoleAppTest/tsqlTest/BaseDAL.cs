	...
	public class BaseDAL
	{
		private static string _connStr
		{
			get
			{
				...
				var connStr = "Data Source=127.0.0.1;Initial Catalog=Test;Persist Security Info=True;User ID=sa;Password=123456";
				return connStr;
			}
		}
		private static IDbConnection _conn = new SqlConnection(_connStr);
